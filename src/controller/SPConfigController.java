 ...
 */
public class SPConfigController implements Initializable {

    @FXML
    private AnchorPane spConfigAnchPane;
    @FXML
    ...
    @FXML
    private JFXTextField playerNameTF;
    ...
    @FXML
    private void playerNameTF_onAction(ActionEvent event) throws IOException {
        String playerName = playerNameTF.getText();
        boolean matches = playerName.matches("[a-z A-Z 0-9]{4,12}");
        if (matches) {
            ...
            new Alert(Alert.AlertType.ERROR, "Something Wrong in Player Name.", ButtonType.OK).show();
            playerNameTF.requestFocus();
            playerNameTF.selectAll();
        }
    }
    ...
    private void homeIcon_onMouseClicked(MouseEvent event) throws IOException {
        ...
        Stage stage = (Stage) this.spConfigAnchPane.getScene().getWindow();
    ...
    private void playIcon_onMouseClicked(MouseEvent event) throws IOException {
        ...
        if (matches) {
            ...
            Scene scene = new Scene(root);
            Stage temp = (Stage) this.spConfigAnchPane.getScene().getWindow();
            temp.close();
